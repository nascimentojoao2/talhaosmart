import type { ExportacaoTalhoes, GeoJsonFeatureCollection, TalhaoOperacional } from './types';
...
function buildGeoJson(talhoes: TalhaoOperacional[]): GeoJsonFeatureCollection {
  return {
...
function buildKml(talhoes: TalhaoOperacional[]) {
...
export function buildTalhoesExport(talhoes: TalhaoOperacional[], format: 'geojson' | 'kml'): ExportacaoTalhoes {
